	...
	<div className="container mx-auto p-4"> 
		...
		<div className="grid grid-cols-1 sm:grid-cols-2 gap-4"> 
			...
			<input id="item" 
				...
				className={` w-full  py-1 px-3 pl-8 border rounded-md focus:outline-none 
		...
		<div className="mt-4 flex justify-between text-center"> 
			...
			{editItem ? ( 
				...
				<button id="five"
				className ="bg-green-500 text-white p-3 rounded-md hover:bg-green-700 mb-4 
				font-semibold focus:outline-none text-xs text-center "
		...
		{nutritionItems.map((item) => ( 
			...
			<ul className="mt-3 "> 
				...
				<div className="flex items-center mt-2 list-image-none text-center "> 
				<button id="four"
					className="bg-green-500 text-white hover:bg-green-600 p-2 rounded-md font-semibold list-image-none  "
				...
				<button id="three"
					className="bg-red-500 text-white hover:bg-red-600 p-2 rounded-md font-semibold"
					onClick={() => updateItemQuantity(item.id, -1)} 
				> 
